...
class Product
{
     ...
     * @Assert\Length(min=3, max=255, minMessage="Le nom du produit doit avoir au moins 3 caracteres")
     */
    private $name;
     ...
     * @Assert\Length(min=20, minMessage="La description courte doit quand meme faire au moins 20 caracteres")
     */
    ...
    /*    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        $metadata->addPropertyConstraints('name', [
            ...
            new Assert\Length(['min' => 3, 'max' => 255, 'minMessage' => 'Le nom du produit doit contenir
